...
if(length(unique(V5_list$date)) == length(unique(V6_list$date))){
  print("There is the name number of images in V5 and in V6")
}else{
  print("There isn't the name number of images in V5 and in V6")
  
}
if(nrow(V5_list)/6 == length(unique(V6_list$date))){
    print("There is the name number of bands in V5 and in V6")

}else{
    print("There isn't the name number of bands in V5 and in V6")
